...
int csv_writer(std::string filename, std::vector<std::string> vals) {
    ...
    std::string term = "standard of living";
...
int main() {
    ...
    clean_file("C:\\Users\\awyat049\\OneDrive\\Documents\\Coding\\2022_11_14_Twitter_Data\\standard_of_living\\standard_of_living[datetime.date(2016, 10, 28), datetime.date(2016, 10, 31)].csv");
    return 0;
}
