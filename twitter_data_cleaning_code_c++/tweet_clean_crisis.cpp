...
int csv_writer(std::string filename, std::vector<std::string> vals) {
    ...
    std::string term = "housing crisis";
...
int main() {
    ...
    std::string path_folders = "D:\\Documents\\Coding\\C++\\twitter_data_cleaning\\testsets\\final\\Housing Crisis";
    ...
    for (const auto &file : fs::directory_iterator(path_folders)) {
